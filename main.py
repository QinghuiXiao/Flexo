...
if __name__ == "__main__":
    ...
    if args.train:
        TemporalPINN(args.n_int, args.n_sb, args.nt, args.delta_t, args.epochs, args.device, args.seed, args.save_path, args.pre_model_save_path, args.optimizer, args.lr)
